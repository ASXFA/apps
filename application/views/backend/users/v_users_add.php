                                ...
                                <div class="row">
                                    ...
                                    <form action="<?= base_url('users/action_add') ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="user_pangkat" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small class="text-danger"><?= form_error('user_jabatan') ?></small>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="user_unit_kerja" class="form-control" required>
