<!-- HEADER MOBILE  -->
<!-- TEMPATKAN SETELAH TAG BODY -->
<header class="header-mobile d-block d-lg-none">
    <div class="header-mobile__bar">
        <div class="container-fluid">
            <div class="header-mobile-inner">
                <a class="logo" href="<?= base_url('assets/backend/') ?>index.html">
                    <img src="<?= base_url('assets/backend/') ?>images/icon/logo.png" alt="CoolAdmin" />
                </a>
            ...
            <ul class="navbar-mobile__list list-unstyled">
                <li class="has-sub">
                    ...
                    <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                        <li>
                            <a href="<?= base_url('assets/backend/') ?>index.html">Dashboard 1</a>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/backend/') ?>index2.html">Dashboard 2</a>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/backend/') ?>index3.html">Dashboard 3</a>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/backend/') ?>index4.html">Dashboard 4</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?= base_url('assets/backend/') ?>chart.html">
                        <i class="fas fa-chart-bar"></i>Charts</a>
                </li>
                <li>
                    <a href="<?= base_url('assets/backend/') ?>table.html">
                        <i class="fas fa-table"></i>Tables</a>
                </li>
                <li>
                    <a href="<?= base_url('assets/backend/') ?>form.html">
                        <i class="far fa-check-square"></i>Forms</a>
                </li>
                <li>
                    <a href="<?= base_url('assets/backend/') ?>calendar.html">
