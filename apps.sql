...
CREATE TABLE `request` (
  ...
  `req_status` int(3) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `sign_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `request` (`req_id`, `req_user_id`, `req_surat`, `req_user_to`, `req_message`, `req_specimen`, `req_status`, `created_at`, `sign_at`) VALUES
(20, 3, 10, 5, 'ajdasjfpohiphqpfhqwp', 2, 1, '2020-09-06 04:49:25', '2020-09-06 10:07:24');
...
(10, 3, 1, '5', 'WhwFRlFPUApUTQ1LVXBRZFVTV3haPwcBVWMJMFAUDFtREgYYUx4ESFcKB2UCGwE8UFZRY1ExVTZXSwcTXGVRNVBXWBcAfVEPVhpdRlcaBDNaGgVYUWpQE1RmDUxVTVEcVUdXaVowBxtVSAlmUHgMJlF9BitTNwRm', 2, '2020-09-06 01:36:12');
...
(33, 5, 'VjQEaFpmBmgHOQFgBjpaPw--', '2020-09-06 10:09:57');
...
(4, '3243212321123121', '098823864927372112', '$2y$10$ViOH1nSeEMmlbsli/zROH.26ghqtA48d7SOtm1dexOuTUVq3J.2um', 3, 'TESTING 1', 'test1@example.com', 'test pangkat 1', 'TEST JABATAN', 'TEST ORG', 'Pemerintah Provinsi Jawa Barat', 'test unit kerja 1', 'BANDUNG', 'Jawa Barat', '089726362737', NULL, NULL, 0, 3, '2020-08-28 13:26:59', 3, '2020-09-02 12:44:21', NULL, NULL),
...
--
ALTER TABLE `request`
  MODIFY `req_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `se`
  MODIFY `se_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tte`
--
ALTER TABLE `tte`
  MODIFY `tte_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
